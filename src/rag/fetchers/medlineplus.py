...
Queries the public wsearch API (https://wsearch.nlm.nih.gov/ws/query,
...
pass your own via configs/ingest.yaml) to widen coverage.
"""
...
from src.rag.fetchers.base import build_session, fetch_text, polite_delay
from src.rag.schema import DocType, SourceDocument
from src.rag.storage import raw_cache_path
