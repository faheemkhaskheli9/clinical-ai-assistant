...
Every fetcher (MedlinePlus, openFDA, MedQuAD, ...) maps its source-specific
format into this shape before anything is written to local storage, so
downstream chunking/embedding/retrieval code never needs to know which
source a passage came from.
"""
...
class SourceDocument(BaseModel):
    ...
    rather than duplicates a record once this is loaded into a vector store.
    """
